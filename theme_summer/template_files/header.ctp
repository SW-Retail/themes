        ...
        <div class="container">
            <div class="row navigation">
                ...
                <div class="col-6 col-lg-2 pr-4 d-flex align-items-center justify-content-end">
                    ...
                    <a class='sw_customer-options_button position-relative' id="sw_customer_options" > <i class="fas fa-user-alt tmplt_attention_color "></i></a>
            ...
            <div class="row main-navigation" id="main-navigator">
