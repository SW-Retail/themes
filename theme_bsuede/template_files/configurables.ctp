...
{template_def:Hoofdkleur:De hoofdkleur in het thema van uw webshop:color:.tmplt_base_color:background-color:#3e88c8}
...
{template_def:Steunkleur:De steunkleur van uw webshop:color:.tmplt_attention_color:color:#3e88c8}
{template_def:'Call to action kleur':De kleur die aandacht trekt om meer verkoop te maken:color:.tmplt_sales_color,.tmplt_sales_color\:hover:background-color:#3e88c8}
{template_def:Selectie kleur:Deze kleur wordt toegepast op gekozen items:color:.alert-success:background-color:#20124d}
